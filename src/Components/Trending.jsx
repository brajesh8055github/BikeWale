  ...
  return (
    <>
      ...
      <div className="flex mb-4 flex-wrap gap-2">
        <button className="px-4 py-2 font-medium border-b-2 border-teal-500">SCOOTERS</button>
        <button className="px-4 py-2 font-medium">BEST MILEAGE BIKES</button>
        <button className="px-4 py-2 font-medium">SPORTS</button>
        <button className="px-4 py-2 font-medium">CRUISERS</button>
      </div>
      ...
      <button className="border text-teal-500 px-2 py-1 bg-white">Check on-road price</button>
        ...
        <a href="#" className="text-teal-500 font-medium hover:underline">
         ...
         <div>
           ...
           <div>
             <button className="bg-white text-teal-500 px-6 py-2 rounded hover:bg-gray-100 ">Electric Bike</button>
             <button className="bg-white text-teal-500 px-6 py-2 rounded hover:bg-gray-100 ml-2 ">Electric Scooter</button>
             </div>
     </div>
    </>
  );
